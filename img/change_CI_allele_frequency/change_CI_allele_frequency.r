...
# set at current script location
here::i_am("img/change_CI_allele_frequency/change_CI_allele_frequency.r")
data_path <- here("img/change_CI_allele_frequency")


# time steps after start of simulation 
# over which we calculate change in frequencies
t_delta <- 500


##### PLOT WITH ANTIBIOTICS #####

path=here(data_path, "base_output_low_advantage_M13s")
...
path=here(data_path, "no_antibiotics")
