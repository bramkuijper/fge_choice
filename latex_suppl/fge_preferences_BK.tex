...
To understand the underlying forces of selection
acting on CRISPR immune hosts, we consider the change in frequency $f_{\immune} = (S_{\immune} + I_{\immune\badFGE} + I_{\immune\goodFGE})/N$ of CRISPR immune hosts (either susceptible or infected). Ignoring rare mutations, the frequency $f_{\immune}$ of hosts that are CRISPR immune changes according to the following differential equation
\begin{IEEEeqnarray}{rl}
    \frac{\mathrm{d} f_{\immune}}{\mathrm{d} t} &= 
    \frac{1}{N} \left(
        \frac{\mathrm{d}S_{\immune}}{\mathrm{d}t} +
        \frac{\mathrm{d} I_{\immune\goodFGE}}{\mathrm{d}t} + 
        \frac{\mathrm{d} I_{\immune\badFGE}}{\mathrm{d}t} 
        - f_{\immune} \frac{\mathrm{d}N}{\mathrm{d}t} 
    \right)\nonumber \\
    %
